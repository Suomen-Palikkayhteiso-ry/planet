# ADR-0000: Agent-Oriented Repository Context and Autonomous Guidance

**Status:** Accepted
**Date:** 2025-12-18
**Location:** `./agents/adrs/ADR-0000-agent-guidance.md`
...
- **README.md:** Fast orientation guide for agents.
...
## 8. Repository Orientation Index (`README.md`)
...
- Precedence: Tests > ADRs > User Stories > Inline comments.
